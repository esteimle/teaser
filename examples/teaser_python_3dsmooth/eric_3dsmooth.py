...
def execute_teaser_global_registration(source, target):
    ...
    print(est_solution.rotation)

    print("Estimated translation: ")
    print(est_solution.translation)
...
def pair_eval_helper(scene_path, desc_path, gt_mat, frag1_idx, frag2_idx):
    ...
    fragment1_name = "output_" + str(frag1_idx)
    fragment2_name = "output_" + str(frag2_idx)

    # load descriptors
    frag1_desc_file = os.path.join(
        desc_path, fragment1_name + ".ply_1.000000_16_1.750000_3DSmoothNet.npz"
    )
    frag1_desc = np.load(frag1_desc_file)
    frag1_desc = frag1_desc["data"]

    frag2_desc_file = os.path.join(
        desc_path, fragment2_name + ".ply_1.000000_16_1.750000_3DSmoothNet.npz"
    )
    ...
    print("Now drawing registration results ...")
    draw_registration_result(test_matched_key.T, ref_matched_key.T, frag1_pc, frag2_pc, est_mat, max_clique)
...
if __name__ == "__main__":
    ...
    scene_path = os.path.abspath("../example_data/smooth/")
    desc_path = os.path.abspath("../example_data/smooth/")
    gt_path = os.path.abspath("../example_data/smooth/gt.log")
    pair = (2, 3)
